...
static const t_bash_pattern	g_pat_list[] = {
	{P_COMMAND, 3, {WORD, SPACE, WORD}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 3, {WORD, SPACE, SYM}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 3, {SYM, SPACE, SYM}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 3, {SYM, SPACE, WORD}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 3, {SPACE, WORD, SPACE}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 3, {SPACE, SYM, SPACE}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 3, {SPACE, WORD, SYM}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 3, {SPACE, SYM, WORD}, 9, {WORD, SYM, SPACE, ESCAPE,
		ASSIGNMENT, LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 2, {WORD, SYM}, 9, {WORD, SYM, SPACE, ESCAPE, ASSIGNMENT,
		LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 2, {SYM, WORD}, 9, {WORD, SYM, SPACE, ESCAPE, ASSIGNMENT,
		LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 1, {WORD}, 9, {WORD, SYM, SPACE, ESCAPE, ASSIGNMENT,
		LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 1, {SYM}, 9, {WORD, SYM, SPACE, ESCAPE, ASSIGNMENT,
		LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 2, {SPACE, WORD}, 9, {WORD, SYM, SPACE, ESCAPE, ASSIGNMENT,
		LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
	{P_COMMAND, 2, {SPACE, SYM}, 9, {WORD, SYM, SPACE, ESCAPE, ASSIGNMENT,
		LEFTSHIFT, RIGHTSHIFT, DOUBLERIGHTSHIFT, ESCAPE_SPACE}},
