...
static const t_bash_pattern	g_pat_list[] = {
	{P_COMMAND, 3, {WORD, SPACE, WORD}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 3, {WORD, SPACE, SYM}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 3, {SYM, SPACE, SYM}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 3, {SYM, SPACE, WORD}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 3, {SPACE, WORD, SPACE}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 3, {SPACE, SYM, SPACE}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 3, {SPACE, WORD, SYM}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 3, {SPACE, SYM, WORD}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 2, {WORD, SYM}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
	{P_COMMAND, 2, {SYM, WORD}, 7, {WORD, SYM, SPACE, ASSIGNMENT, OP_READ, OP_WRITE, OP_APPEND}},
